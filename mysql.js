...
const dataQuery = (query) => new Promise((resolve, reject) => {
...
const convert = (energyDate, monthsDate, stateDate) => {
    dataQuery('SELECT division.id_division, name_division, states.name_states, vlr_kw_min, vlr_kw_max from caribe.division join caribe.states on states.id_division = division.id_division and name_states = "' + stateDate + '"')
        .then((data) => {
